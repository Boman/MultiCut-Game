...
var clpPromise = new Promise(function(resolve) {
    ...
    if (wasmBlobStr) {
        if (typeof atob === "function") Module["wasmBinary"] = Uint8Array.from(atob(wasmBlobStr), c => c.charCodeAt(0));
        else Module["wasmBinary"] = Buffer.from(wasmBlobStr, "base64")
    }
    ...
    function constraintToStr(row) {
        ...
        return boundedExpression(expression, row.bnds.lb, row.bnds.ub, row.bnds.type)
    }
    ...
    function toLpFormat(lp) {
        ...
        if (lp.bounds) {
            ...
            for (var col of lp.bounds) {
                var_bounds_str += boundedExpression(col.name, col.bnds.lb, col.bnds.ub, col.bnds.type)
            }
            str += "Bounds\n" + var_bounds_str + "\n"
        }
        str += "End\n";
    ...
    var wasmBinaryFile = "clp-wasm.wasm";
    ...
    var dynCall_iiiiij = Module["dynCall_iiiiij"] = function() {
        return (dynCall_iiiiij = Module["dynCall_iiiiij"] = Module["asm"]["aa"]).apply(null, arguments)
    };
    var dynCall_iiiiijj = Module["dynCall_iiiiijj"] = function() {
        return (dynCall_iiiiijj = Module["dynCall_iiiiijj"] = Module["asm"]["ba"]).apply(null, arguments)
    };
    var calledRun;
...
if (typeof module !== "undefined") module.exports = clpPromise;
if (typeof define === "function") define(clpPromise);