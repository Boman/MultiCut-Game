...
def solve_multicut(graph: nx.Graph, log: bool = True):
    """
    ...
    variables = model.addVars(graph.edges, obj={(u,v): w for u, v, w in graph.edges.data('weight')}, vtype=GRB.BINARY, name='e')
...
def main():
    ...
    # call the solver
    multicut, obj = solve_multicut(graph)
